close all;
%% Read the fits file
img_1 = fitsread('G:\Fuzzy_Active_Contour\Solar_Image_2017_fits\AIA20170130_2300_0193.fits','image'); %% Read magnetogram fits file 
...
figure,subplot(221),imshow((img_3)), %% Display image 
